...
import il.ac.hit.handlers.Handler;
...
public class TcpServer implements Closeable {
   ...
   application layer believe processes on hosts are connected by a data stream
    ...
    public void run(Handler concreteHandler) {
    ...
    private void acceptRequests() {
        ...
        try {
             ...
             */
                Runnable clientHandling = () -> handleRequest(serverToSpecificClient);
    ...
    private void handleRequest(Socket serverToSpecificClient) {
        try {
            ...
            if (!stopServer) {
                System.err.println("encountered an error while handling client");
                e.printStackTrace();
            }
        }
    }
